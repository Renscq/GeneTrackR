...
vignette: >
  %\VignetteIndexEntry{10 Phenotype association}
...
GeneTrackR treats phenotype analysis as an explicit sample-matching problem. Phenotype rows are joined to haplotype or variant genotypes by `sample_id`, not by row order. The recommended analysis therefore starts with phenotype QC and sample-overlap checks, then performs haplotype- or variant-level tests while retaining the returned statistics together with the figure.
