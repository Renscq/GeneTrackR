...
if (identical(unname(desc[["License"]]), "GPL + file LICENSE")) {
  add_warn(
    "License remains the historical generic GPL + file LICENSE form; choose a specific standard GPL version before 0.99.0 if that matches the intended licensing terms."
  )
}
