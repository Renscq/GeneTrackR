...
if (!file.exists(news_file)) {
  ...
  if (!grepl("# GeneTrackR 0.8.6", news_text, fixed = TRUE)) {
    add_fail("NEWS.md does not contain the current GeneTrackR 0.8.6 release entry.")
  } else {
...
# 0.8.6 BiocCheck-focused static checks
