...
# Date: 2026-09-01
# Version: dev011
# Function: Formal 0.99.x Bioconductor submission preflight for the GeneTrackR source tree
...
if (!file.exists(news_file)) {
  ...
  if (!grepl("# GeneTrackR 0.99.0", news_text, fixed = TRUE)) {
    add_fail("NEWS.md does not contain the current GeneTrackR 0.99.0 submission entry.")
  } else {
